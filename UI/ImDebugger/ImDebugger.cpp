...
static void DrawInternals(ImConfig &cfg) {
	...
	static const entry dirs[] = {
		{DIRECTORY_PSP, "GMP"},
		{DIRECTORY_CHEATS, "CHEATS (Sistema/Cheats)"},
		{DIRECTORY_SCREENSHOT, "SCREENSHOT (Sistema/SCREENSHOT)"},
		{DIRECTORY_SYSTEM, "SYSTEM (Sistema/SYSTEM)"},
		{DIRECTORY_GAME, "GAME (Jogo/Game)"},
		{DIRECTORY_SAVEDATA, "SAVEDATA (Jogo/Save)"},
		{DIRECTORY_PAUTH, "PAUTH"},
		{DIRECTORY_DUMP, "DUMP (Sistema/SYSTEM/DUMP)"},
		{DIRECTORY_SAVESTATE, "SAVESTATE (Sistema/PPSSPP_STATE)"},
		{DIRECTORY_CACHE, "CACHE (Sistema/SYSTEM/CACHE)"},
		{DIRECTORY_TEXTURES, "TEXTURES (Textura)"},
		{DIRECTORY_PLUGINS, "PLUGINS (Sistema/PLUGINS)"},
		{DIRECTORY_APP_CACHE, "APP_CACHE"},
		{DIRECTORY_VIDEO, "VIDEO (Sistema/VIDEO)"},
		{DIRECTORY_AUDIO, "AUDIO (Sistema/AUDIO)"},
		{DIRECTORY_MEMSTICK_ROOT, "MEMSTICK_ROOT"},
		{DIRECTORY_EXDATA, "EXDATA"},
		{DIRECTORY_CUSTOM_SHADERS, "CUSTOM_SHADERS (Sistema/shaders)"},
		{DIRECTORY_CUSTOM_THEMES, "CUSTOM_THEMES (Sistema/themes)"},
	};
